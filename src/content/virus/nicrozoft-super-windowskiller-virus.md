...
该病毒破坏性性碾压 MEMZ，熊猫烧香，Windows XP Horror Edition，Wannacry 等已知的 99.99% 的病毒！
如果测试此病毒，请确认你在一个安全的环境运行。Nicrozoft 将不会对该病毒造成的损失承担任何责任。下载即同意此条款。

### 以下是 6.6.6 版的内容

该版本有 x64 版本。该版本的病毒可以彻底破坏计算机、死锁固件、清除数据。
内部正式版为 Nicrozoft 机密，因此设有密码。
...
你可以到旧版 Nicrozoft 网站下载早期版本的 Nicrozoft_Super_WindowsKiller_Virus。
